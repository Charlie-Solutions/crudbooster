...
class AdminCmsUsersController extends CBController {
	...
	public function cbInit() {
		...
		$this->form[] = array("label"=>"Mot de passe","name"=>"password","type"=>"password","help"=>"Please leave empty if not change");
		$this->form[] = array("label"=>"Confirmation","name"=>"password_confirmation","type"=>"password","help"=>"Please leave empty if not change");
