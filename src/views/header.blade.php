                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                ...
                                <small><em id="codeclient"></em></small>
                            </p>
                        </li>
                        ...
                        <li class="user-footer">
                            ...
                            <div>
                                <a title='Changer de mode' class='btn btn-default btn-flat' id="mode"><i id="icone-mode" class='fa fa-moon-o'></i></a>
                            </div>
                        </li>
                    </ul>
                </li>
...
<script type="text/javascript">
    var username = <?php echo json_encode($user_name, JSON_PRETTY_PRINT) ?>;
    $.ajax({
        type:"GET",
        url:'/verify_code_client',
        data:{username:username},
        success:function(response){
            var json = JSON.parse(response);
            if(json['status'] == 200){
                $('#codeclient').append("Code client : <b>"+json['code_client']+"</b>");
            }else if(json['status'] == 201){
                $('#codeclient').append("<b>"+json['date']+"</b>");
            }
        },
        error: function(codeErreur){string = JSON.stringify(codeErreur);}
    });
